    ...
    <section id='newsletter'>
      ...
      <div className='container py-24 sm:py-32'>
        <h3 className='text-center text-4xl md:text-5xl font-bold'>
          Join our <span className='bg-gradient-to-b from-primary/60 to-primary text-transparent bg-clip-text'>newsletter</span>!
        </h3>
        ...
        <form className='flex flex-col w-full md:flex-row md:w-6/12 lg:w-4/12 mx-auto gap-4 md:gap-2' onSubmit={handleSubmit}>
          <Input placeholder='denis.ronchese.tech@gmail.com' className='bg-muted/50 dark:bg-muted/80 ' aria-label='email' />
